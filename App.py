...
if st.button("Run Optimization"):
    if filtered_data.empty:
        ...
        # Constraints
        # 1. Each flight can be assigned to at most one gate
        for f in flights:
        ...
        # 3. Ensure the total assignments equals the number of gates
        model += pulp.lpSum(flight_gate[f, g] for f in flights for g in gates) == max_gates
    ...
    options = [
        ...
        "Variance Decomposition of Delay"
    ]
